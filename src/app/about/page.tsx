...
const values = [
  {
    ...
    title: "Clean Code",
    description:
      "I believe in writing clean, maintainable, and well-documented code that stands the test of time.",
  },
  {
    icon: <Target className="h-8 w-8 text-green-600" />,
    title: "Goal-Oriented",
    description:
      "Every project has clear objectives, and I ensure we meet them efficiently and effectively.",
  },
  {
    icon: <Heart className="h-8 w-8 text-red-600" />,
    title: "Passionate",
    description:
      "I&apos;m passionate about technology and love creating solutions that make a real difference.",
  },
  {
    icon: <Users className="h-8 w-8 text-purple-600" />,
    title: "Collaborative",
    description:
      "Great software is built by great teams. I value collaboration and open communication.",
  },
];
            ...
            <Card className="p-8 shadow-lg border-0 bg-white/80 backdrop-blur-sm">
              <CardContent className="space-y-6">
                <p className="text-lg text-gray-700 leading-relaxed">
                  ...
                  college years at Silver Oak University, where I discovered my
                  passion for creating digital solutions that solve real-world
                  problems.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  What started as curiosity about how websites work evolved into
                  a deep fascination with full-stack development. I&apos;ve had
                  the privilege of working with amazing teams at Team Unibrains,
                  where I&apos;ve honed my skills in React, NestJS, and modern
                  web technologies.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  Today, I specialize in building scalable web applications
                  using cutting-edge technologies like GraphQL, TypeORM, and
                  Prisma. My goal is to create software that not only meets
                  technical requirements but also provides exceptional user
                  experiences.
                </p>
              </CardContent>
            </Card>
          ...
          <motion.div variants={fadeInUp}>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              ...
              >
                ...
                <p className="text-blue-100">
                  Gaming helps me think creatively
                </p>
              </motion.div>
