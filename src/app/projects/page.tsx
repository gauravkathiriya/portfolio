...
const projects = [
  ...
  },
  {
    ...
    description:
      "Modern weather forecasting app with location-based weather data, 7-day forecasts, and interactive weather maps.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Comprehensive auction platform with real-time bidding, user authentication, and payment integration.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Collaborative task management tool with team features, project tracking, and productivity analytics.",
    longDescription:
      "A powerful project management tool designed for teams. Features include task assignments, progress tracking, time logging, and comprehensive reporting.",
  ...
  },
  {
    ...
    description:
      "RESTful API for e-commerce applications with authentication, product management, and order processing.",
    longDescription:
      "A robust backend API built with NestJS, featuring comprehensive e-commerce functionality including user management, product catalog, shopping cart, and order processing.",
    technologies: [
      "NestJS",
      "TypeORM",
      "PostgreSQL",
